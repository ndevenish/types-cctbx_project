...
class linear_correlation:
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def coefficient(scitbx) -> Any: ...
    @classmethod
    def denominator(scitbx) -> Any: ...
    @classmethod
    def is_well_defined(scitbx) -> Any: ...
    @classmethod
    def mean_x(scitbx) -> Any: ...
    @classmethod
    def mean_y(scitbx) -> Any: ...
    @classmethod
    def n(scitbx) -> Any: ...
    @classmethod
    def numerator(scitbx) -> Any: ...
    @classmethod
    def sum_denominator_x(scitbx) -> Any: ...
    @classmethod
    def sum_denominator_y(scitbx) -> Any: ...
    def __reduce__(self) -> Any: ...
...
class linear_regression_core:
    ...
    def is_well_defined(scitbx) -> Any: ...
    @classmethod
    def slope(scitbx) -> Any: ...
    @classmethod
    def y_intercept(scitbx) -> Any: ...
    def __reduce__(self) -> Any: ...
...
class mean_and_variance:
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def gsl_stats_wsd(scitbx) -> Any: ...
    @classmethod
    def gsl_stats_wvariance(scitbx) -> Any: ...
    @classmethod
    def have_weights(scitbx) -> Any: ...
    @classmethod
    def mean(scitbx) -> Any: ...
    @classmethod
    def standard_error_of_mean_calculated_from_sample_weights(scitbx) -> Any: ...
    @classmethod
    def sum_weights(scitbx) -> Any: ...
    @classmethod
    def sum_weights_delta_sq(scitbx) -> Any: ...
    @classmethod
    def sum_weights_sq(scitbx) -> Any: ...
    @classmethod
    def sum_weights_values(scitbx) -> Any: ...
    @classmethod
    def unweighted_sample_standard_deviation(scitbx) -> Any: ...
    @classmethod
    def unweighted_sample_variance(scitbx) -> Any: ...
    @classmethod
    def unweighted_standard_error_of_mean(scitbx) -> Any: ...
    def __reduce__(self) -> Any: ...
...
class mersenne_twister:
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def getstate(scitbx) -> Any: ...
    @classmethod
    def random_bool(scitbx, unsignedlong, double) -> Any: ...
    @classmethod
    @overload
    ...
    @classmethod
    def random_double_point_on_sphere(scitbx) -> Any: ...
    @classmethod
    def random_double_r3_rotation_matrix(scitbx) -> Any: ...
    @classmethod
    def random_double_r3_rotation_matrix_arvo_1992(scitbx) -> Any: ...
    @classmethod
    def random_double_unit_quaternion(scitbx) -> Any: ...
    def random_int_gaussian_distribution(self, *args, **kwargs) -> Any: ...
    @classmethod
    def random_permutation(scitbx, unsignedlong) -> Any: ...
    @classmethod
    @overload
    ...
    @classmethod
    def random_size_t_max(scitbx) -> Any: ...
    @classmethod
    def random_size_t_min(scitbx) -> Any: ...
    @classmethod
    def seed(scitbx) -> Any: ...
