...
int_ = __builtins__.int
float_ = __builtins__.float
bool_ = __builtins__.bool
...
@type_check_only
class FlexNumericCommon(FlexPlain):
...
@type_check_only
class FlexNumericNoPow(FlexNumericCommon):
...
@type_check_only
class FlexNumeric(FlexNumericCommon):
    def norm(self, *args, **kwargs) -> Any: ...
    def __pow__(self, other) -> Any: ...
    def __abs__(self) -> Any: ...

@type_check_only
class FlexInteger(FlexNumericNoPow):
    def __mod__(self, other) -> Any: ...
    def __imod__(self, other) -> Any: ...
    def __rmod__(self, other) -> Any: ...

@type_check_only
class FlexSignedInteger(FlexInteger):
    pass

@type_check_only
class FlexOrdered(FlexPlain):
    def __eq__(self, other) -> Any: ...
    def __ne__(self, other) -> Any: ...
    def all_eq(self, *args, **kwargs) -> Any: ...
    def all_ne(self, *args, **kwargs) -> Any: ...

class bool(FlexPlain):
...
class complex_double(FlexNumericCommon):
    def __init__(self, *args, **kwargs) -> None: ...
...
class double(FlexNumeric):
    ...
    def matrix_copy_block(
        self: T, i_row: int_, i_column: int_, i_rows: int_, i_columns: int_
    ) -> T: ...
...
class grid:
    ...
    def __setstate__(self, state) -> Any: ...
    # Injected
    def show_summary(self, f: Any | None = ...): ...
...
class histogram:
    ...
    def show(
        self, f: Any | None = ..., prefix: str = ..., format_cutoffs: str = ...
    ) -> None: ...
    def as_str(self, prefix: str = ..., format_cutoffs: str = ...): ...

class int(FlexSignedInteger):
    def __init__(self, *args, **kwargs) -> None: ...
...
class linear_correlation:
    def __init__(
        self, x: float, y: float, epsilon: float_ = 1.0e-15, subtract_mean: bool = True
    ) -> None: ...
    def coefficient(self) -> float_: ...
    def denominator(self) -> float_: ...
    def is_well_defined(self) -> bool_: ...
    def mean_x(self) -> float_: ...
    def mean_y(self) -> float_: ...
    def n(self) -> int_: ...
    def numerator(self) -> float_: ...
    def sum_denominator_x(self) -> float_: ...
    def sum_denominator_y(self) -> float_: ...
    def __reduce__(self) -> Any: ...
    # Injected
...
class sym_mat3_double(FlexPlain):
    def __init__(self, *args, **kwargs) -> None: ...
    def copy_selected(self, *args, **kwargs) -> Any: ...
    def front(self, *args, **kwargs) -> Any: ...
...
class vec2_double(FlexPlain):
    @classmethod
    def __init__(boost, scitbx) -> Any: ...
    def add_selected(self, *args, **kwargs) -> Any: ...
    def copy_selected(self, *args, **kwargs) -> Any: ...
...
def select(sequence, permutation: Any | None = ..., flags: Any | None = ...): ...
...
class smart_selection:
    ...
    def show_summary(
        self, out: Any | None = ..., prefix: str = ..., label: str = ...
    ) -> None: ...
...
def exercise_triple(
    flex_triple, flex_order: Any | None = ..., as_double: bool = ...
) -> None: ...
def compare_derivatives(more_reliable, less_reliable, eps: float = ...) -> None: ...
def sum(flex_array, axis: Any | None = ...): ...
