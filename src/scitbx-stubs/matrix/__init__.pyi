from typing import Any, Container, Iterator, Sequence, Type, Union
...
class rec:
    ...
    def __mul__(self, other: Union[rec, Sequence]) -> rec: ...
    def __rmul__(self, other: Union[rec, Sequence]) -> rec: ...
