...
class least_squares_fit:
    ...
    def other_sites_best_fit(self, additional_sites: Any | None = ...): ...
    def rt(self): ...

def sieve_fit(
    sites_fixed, sites_moving, selection: Any | None = ..., frac_discard: float = ...
): ...
...
class nsd_engine:
    ...
    d_moving: Any
    def __init__(
        self, fixed, d_fixed: Any | None = ..., d_moving: Any | None = ...
    ) -> None: ...
    def get_mean_distance(self, xyz): ...
    def nsd(self, moving, d_moving: Any | None = ...): ...
