...
class unit_cell:
    ...
    def __init__(
        ...
        orthogonalization_matrix: rec | None = ...,
    ) -> None: ...
    ...
    def debye_waller_factors(
        self,
        miller_index: Any | None = ...,
        miller_indices: Any | None = ...,
        u_iso: Any | None = ...,
        b_iso: Any | None = ...,
        u_cart: Any | None = ...,
        b_cart: Any | None = ...,
    ...
    def is_buerger_cell(self, relative_epsilon: Any | None = ...): ...
    ...
    def is_niggli_cell(self, relative_epsilon: Any | None = ...): ...
    ...
    def minimum_cell(
        self,
        iteration_limit: Any | None = ...,
        multiplier_significant_change_test: Any | None = ...,
        min_n_no_significant_change: Any | None = ...,
    ): ...
    ...
    def show_parameters(self, f: Any | None = ..., prefix: str = ...) -> None: ...
